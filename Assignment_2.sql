...
VALUES  (11, 'Pranav', 'Karwar', 200), (24, 'Prasanna', 'Bengaluru', 300), (15, 'Prokta', 'Mysore', 200.2), 
...
SELECT s.salesman_id, s.name AS Salesman_Name, s.city AS Salesman_City, s.commission
FROM salesman s
LEFT JOIN customer c ON s.salesman_id = c.salesman_id
LEFT JOIN [order] o ON c.customer_id = o.customer_id
